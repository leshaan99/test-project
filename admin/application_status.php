...
// Form Configuration
$form_config = [
    'heading' => 'Application Status Label',
    'form_action' => 'data/register_application_status.php',
    'inputs' => [
        'id' => ['type' => 'hidden', 'value' => ''],
        'f1' => ['label' => 'Label', 'type' => 'text', 'class' => 'form-control', 'div_class' => 'col-lg-4 col-md-14 form-group','required' => true],
        'f2' => ['label' => 'Description', 'type' => 'textarea', 'class' => 'form-control', 'div_class' => 'col-lg-4 col-md-14 form-group'],
...
$row = $id > 0 ? $applicationStatus->get_by_id($id)['data'] : null;
