...
$form_config = [
    ...
    'inputs' => [
        ...
        'f1' => ['label' => 'Title', 'type' => 'text', 'class' => 'form-control', 'div_class' => 'col-lg-12 col-md-12 form-group','required' => true],
        'f2' => ['label' => 'Sub Title', 'type' => 'text', 'class' => 'form-control', 'div_class' => 'col-lg-12 col-md-12 form-group'],
        'f3' => ['label' => 'Description', 'type' => 'textarea', 'class' => 'form-control summernote', 'div_class' => 'col-lg-12 col-md-12 form-group'],
...
$row = $id > 0 ? $event->get_by_id($id)['data'] : null;
