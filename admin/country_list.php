...
$form_config = [
    ...
    'new' => 'country',
    'title' => 'list',
    'table' => ['th' => ['Country Name','View Universities','Image', 'Action']],
    'db_table' => 'countries',
    'redirect' => 'country_list',
];

$list = $country->get_all_with_delete()['error'] === null ? $country->get_all_with_delete()['data'] : null;
?>
                                ...
                                <?php if ($list) {
                                    ...
                                    foreach ($list as $row) { ?>
                                        <tr>
                                            ...
                                            <td><a href="university_list?country=<?= base64_encode($row['id']); ?>">View</a></td>
                                            <td><img src="../<?= $row['img1'] ?>" style="width: 300px; height: 100px;" alt ="Product Image">
                                            </td>
                                            <td>
                                                <?php if ($row['status'] == '1') { ?>
