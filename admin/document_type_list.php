...
$form_config = [
    'heading' => 'Document Type List',
    'title' => 'list',
    'new' => 'document_type',
    'table' => ['th' => ['Document Name','Action']],
    'db_table' => 'document_types',
    'redirect' => 'document_type_list',


];

$list = $documentTypes->get_all_with_delete()['error'] === null ? $documentTypes->get_all_with_delete()['data'] : null;
