...
$form_config = [
    'heading' => 'Country',
    'form_action' => 'data/register_country.php',
    'inputs' => [
        'id' => ['type' => 'hidden', 'value' => ''],
        'f1' => ['label' => 'Name', 'type' => 'text', 'class' => 'form-control', 'div_class' => 'col-lg-4 col-md-4 form-group','required' => true],
        'f2' => ['label' => 'Description 01', 'type' => 'textarea', 'class' => 'form-control summernote', 'div_class' => 'col-lg-12 col-md-12 form-group'],
        'f3' => ['label' => 'Description 02', 'type' => 'textarea', 'class' => 'form-control summernote', 'div_class' => 'col-lg-12 col-md-12 form-group'],
...
$row = ($id > 0 && isset($country)) ? $country->get_by_id($id)['data'] : null;
